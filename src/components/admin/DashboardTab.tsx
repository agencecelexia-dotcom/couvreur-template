...
const INITIAL_SUBMISSIONS: Submission[] = [
  {
    ...
    service: "Déménagement local",
    subject: "Déménagement appartement T4 vers maison",
    message: "Bonjour, nous déménageons d'un T4 au 3e étage sans ascenseur vers une maison. Environ 60m³ de mobilier. Pouvez-vous nous faire un devis ?",
  ...
  },
  {
    ...
    subject: "Déménagement maison longue distance",
    message: "Nous déménageons notre maison de 120m² vers une autre région. Besoin d'emballage complet et monte-meuble. Budget prévu : 5 000€.",
  ...
  },
  {
    ...
    subject: "Stockage 15m³ pendant travaux — 3 mois",
    message: "Je recherche un garde-meuble sécurisé pour environ 15m³ de mobilier pendant 3 mois, le temps de nos travaux de rénovation.",
  ...
  },
  {
    ...
    service: "Monte-meuble",
    subject: "Monte-meuble 5e étage — armoire + canapé",
    message: "J'ai besoin d'un monte-meuble pour monter une armoire 3 portes et un canapé d'angle au 5e étage. Cage d'escalier trop étroite.",
  ...
  },
  {
    ...
    service: "Déménagement bureau",
    subject: "Déménagement bureaux 200m² — 15 postes",
    message: "Projet de déménagement de nos bureaux (200m², 15 postes de travail, serveur informatique). Doit se faire sur un weekend pour ne pas interrompre l'activité.",
